...
//INPUTS PINS:
int ENGINES_SLIDER_PIN_INPUT_FROM_ESP = A14; //analog data from esp //A14 to GP5(D1)
int MOTOR1_DIR = 12;
int MOTOR1_SPEED = 10;
int MOTOR2_DIR = 13;
int MOTOR2_SPEED = 11;
//madaf_servo_ver02:
//INPUTS PINS:
int MADAF_SERVO_PIN_INPUT_FROM_ESP = A15; //analog data from esp //A15 to GP4(D2)
int MADAF_SERVO_PIN_INPUT_FROM_SERVO = 9; //digital pin in arduino (orange wire)
//delet_ver01:
//INPUTS PINS:
#define PIN_INPUT_SERVO_ON_OFF 52 //D52 TO GP0(D3)
#define PIN_PWM_SERVO 8 //(orange wire)
//laser on/off:
#define PIN_INPUT_LASER 53 //D53 TO GP2(D4)
#define PIN_OUTPUT_LASER 51
